...
public class ExpressionsFactoryImpl extends EFactoryImpl implements ExpressionsFactory {
	...
	public static ExpressionsFactory init() {
		try {
			ExpressionsFactory theExpressionsFactory = (ExpressionsFactory)EPackage.Registry.INSTANCE.getEFactory("null"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ExpressionsPackage.TIMES: return createTimes();
			case ExpressionsPackage.PARENTHESIS: return createParenthesis();
			case ExpressionsPackage.INTEGER: return createInteger();
			default:
	 ...
	 * @generated
	 */
	public editortest.emf.expressions.emfmodel.Integer createInteger() {
