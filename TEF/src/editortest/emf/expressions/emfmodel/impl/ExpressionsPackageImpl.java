...
public class ExpressionsPackageImpl extends EPackageImpl implements ExpressionsPackage {
	 ...
	 * @see editortest.emf.expressions.emfmodel.ExpressionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getOperator_Operand1() {
	 ...
	 * @generated
	 */
	public EReference getOperator_Operand2() {
	 ...
	 * @generated
	 */
	public EReference getParenthesis_Subexpression() {
	...
	public void createPackageContents() {
		...
		createEReference(operatorEClass, OPERATOR__OPERAND1);
		createEReference(operatorEClass, OPERATOR__OPERAND2);
		...
		createEReference(parenthesisEClass, PARENTHESIS__SUBEXPRESSION);
	...
	public void initializePackageContents() {
		...
		timesEClass.getESuperTypes().add(this.getOperator());
		...
		initEReference(getOperator_Operand1(), this.getExpression(), null, "operand1", null, 0, 1, Operator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperator_Operand2(), this.getExpression(), null, "operand2", null, 0, 1, Operator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getParenthesis_Subexpression(), this.getExpression(), null, "subexpression", null, 0, 1, Parenthesis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(integerEClass, editortest.emf.expressions.emfmodel.Integer.class, "Integer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInteger_Value(), ecorePackage.getEString(), "value", null, 0, 1, editortest.emf.expressions.emfmodel.Integer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
