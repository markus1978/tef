 ...
 * <ul>
 *   <li>{@link hub.sam.sdl.CoreAbstractionsRelationshipsRelationship#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 * </p>
 *
...
public interface CoreAbstractionsRelationshipsRelationship extends CoreAbstractionsOwnershipsElement {
	 ...
	 * @see hub.sam.sdl.EmfSdlPackage#getCoreAbstractionsRelationshipsRelationship_RelatedElement()
	 * @model required="true" derived="true" ordered="false"
	 * @generated
	 */
	EList<CoreAbstractionsOwnershipsElement> getRelatedElement();
