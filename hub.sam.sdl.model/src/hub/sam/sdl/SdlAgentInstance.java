...
public interface SdlAgentInstance extends SdlInstance {
	...
	/**
	 * Returns the value of the '<em><b>Owning Instance Set</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Owning Instance Set</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Owning Instance Set</em>' reference.
	...
	/**
	 * Sets the value of the '{@link hub.sam.sdl.SdlAgentInstance#getOwningInstanceSet <em>Owning Instance Set</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Owning Instance Set</em>' reference.
