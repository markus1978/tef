 ...
 * <ul>
 *   <li>{@link hub.sam.sdl.impl.CommunicationProcessImpl#getInput <em>Input</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CommunicationProcessImpl extends CoreAbstractionsElementsElementImpl implements CommunicationProcess {
	...
	public EList<CommunicationListener> getInput() {
		if (input == null) {
			input = new EObjectContainmentEList<CommunicationListener>(CommunicationListener.class, this, EmfSdlPackage.COMMUNICATION_PROCESS__INPUT);
		}
		return input;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmfSdlPackage.COMMUNICATION_PROCESS__INPUT:
