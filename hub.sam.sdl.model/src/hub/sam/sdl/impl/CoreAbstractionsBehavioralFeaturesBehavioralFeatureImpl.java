 ...
 *   <li>{@link hub.sam.sdl.impl.CoreAbstractionsBehavioralFeaturesBehavioralFeatureImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CoreAbstractionsBehavioralFeaturesBehavioralFeatureImpl extends CoreAbstractionsNamespacesNamespaceImpl implements CoreAbstractionsBehavioralFeaturesBehavioralFeature {
	...
	public EList<CoreAbstractionsBehavioralFeaturesParameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectResolvingEList<CoreAbstractionsBehavioralFeaturesParameter>(CoreAbstractionsBehavioralFeaturesParameter.class, this, EmfSdlPackage.CORE_ABSTRACTIONS_BEHAVIORAL_FEATURES_BEHAVIORAL_FEATURE__PARAMETER);
		}
		return parameter;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EmfSdlPackage.CORE_ABSTRACTIONS_BEHAVIORAL_FEATURES_BEHAVIORAL_FEATURE__PARAMETER:
				return getParameter();
		}
