 ...
 *   <li>{@link hub.sam.sdl.impl.EvaluationBehavioralFeatureAccessExpressionImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EvaluationBehavioralFeatureAccessExpressionImpl extends EvaluationBehavioralFeatureAccessImpl implements EvaluationBehavioralFeatureAccessExpression {
	...
	public CoreAbstractionsClassifiersFeature getFeature() {
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS_EXPRESSION__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(CoreAbstractionsClassifiersFeature newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS_EXPRESSION__FEATURE, oldFeature, feature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS_EXPRESSION__FEATURE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CoreAbstractionsTypedElementsTypedElement.class) {
			switch (derivedFeatureID) {
				case EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS_EXPRESSION__TYPE: return EmfSdlPackage.CORE_ABSTRACTIONS_TYPED_ELEMENTS_TYPED_ELEMENT__TYPE;
				default: return -1;
			}
		}
		...
		if (baseClass == EvaluationFeatureAccessExpression.class) {
			switch (derivedFeatureID) {
				case EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS_EXPRESSION__FEATURE: return EmfSdlPackage.EVALUATION_FEATURE_ACCESS_EXPRESSION__FEATURE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CoreAbstractionsTypedElementsTypedElement.class) {
			switch (baseFeatureID) {
				case EmfSdlPackage.CORE_ABSTRACTIONS_TYPED_ELEMENTS_TYPED_ELEMENT__TYPE: return EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS_EXPRESSION__TYPE;
				default: return -1;
			}
		}
		if (baseClass == EvaluationExpression.class) {
		...
		if (baseClass == EvaluationFeatureAccessExpression.class) {
			switch (baseFeatureID) {
				case EmfSdlPackage.EVALUATION_FEATURE_ACCESS_EXPRESSION__FEATURE: return EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS_EXPRESSION__FEATURE;
				default: return -1;
			}
		}
