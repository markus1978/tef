 ...
 * <ul>
 *   <li>{@link hub.sam.sdl.impl.EvaluationBehavioralFeatureAccessImpl#getArgument <em>Argument</em>}</li>
...
public abstract class EvaluationBehavioralFeatureAccessImpl extends EObjectImpl implements EvaluationBehavioralFeatureAccess {
	...
	public EList<EvaluationExpression> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<EvaluationExpression>(EvaluationExpression.class, this, EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS__ARGUMENT);
		}
		return argument;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmfSdlPackage.EVALUATION_BEHAVIORAL_FEATURE_ACCESS__ARGUMENT:
