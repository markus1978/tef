 ...
 *   <li>{@link hub.sam.sdl.impl.EvaluationExpressionImpl#getTypedElement_type <em>Typed Element type</em>}</li>
...
public abstract class EvaluationExpressionImpl extends CoreAbstractionsElementsElementImpl implements EvaluationExpression {
	...
	public CoreAbstractionsTypedElementsType getTypedElement_type() {
		if (typedElement_type != null && typedElement_type.eIsProxy()) {
			...
			if (typedElement_type != oldTypedElement_type) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmfSdlPackage.EVALUATION_EXPRESSION__TYPED_ELEMENT_TYPE, oldTypedElement_type, typedElement_type));
			}
		}
	...
	public void setTypedElement_type(CoreAbstractionsTypedElementsType newTypedElement_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfSdlPackage.EVALUATION_EXPRESSION__TYPED_ELEMENT_TYPE, oldTypedElement_type, typedElement_type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EmfSdlPackage.EVALUATION_EXPRESSION__TYPED_ELEMENT_TYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CoreAbstractionsTypedElementsTypedElement.class) {
			switch (derivedFeatureID) {
				case EmfSdlPackage.EVALUATION_EXPRESSION__TYPED_ELEMENT_TYPE: return EmfSdlPackage.CORE_ABSTRACTIONS_TYPED_ELEMENTS_TYPED_ELEMENT__TYPED_ELEMENT_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CoreAbstractionsTypedElementsTypedElement.class) {
			switch (baseFeatureID) {
				case EmfSdlPackage.CORE_ABSTRACTIONS_TYPED_ELEMENTS_TYPED_ELEMENT__TYPED_ELEMENT_TYPE: return EmfSdlPackage.EVALUATION_EXPRESSION__TYPED_ELEMENT_TYPE;
				default: return -1;
			}
		}
