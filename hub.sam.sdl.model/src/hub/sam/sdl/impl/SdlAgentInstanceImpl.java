...
public class SdlAgentInstanceImpl extends SdlInstanceImpl implements SdlAgentInstance {
	...
	/**
	 * The cached value of the '{@link #getOwningInstanceSet() <em>Owning Instance Set</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected SdlAgentInstanceSet owningInstanceSet;
	...
	public SdlAgentInstanceSet getOwningInstanceSet() {
		if (owningInstanceSet != null && owningInstanceSet.eIsProxy()) {
			InternalEObject oldOwningInstanceSet = (InternalEObject)owningInstanceSet;
			owningInstanceSet = (SdlAgentInstanceSet)eResolveProxy(oldOwningInstanceSet);
			if (owningInstanceSet != oldOwningInstanceSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmfSdlPackage.SDL_AGENT_INSTANCE__OWNING_INSTANCE_SET, oldOwningInstanceSet, owningInstanceSet));
			}
		}
		return owningInstanceSet;
	}
	 ...
	 * @generated
	 */
	public SdlAgentInstanceSet basicGetOwningInstanceSet() {
		return owningInstanceSet;
	}
	...
	public void setOwningInstanceSet(SdlAgentInstanceSet newOwningInstanceSet) {
		SdlAgentInstanceSet oldOwningInstanceSet = owningInstanceSet;
		owningInstanceSet = newOwningInstanceSet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfSdlPackage.SDL_AGENT_INSTANCE__OWNING_INSTANCE_SET, oldOwningInstanceSet, owningInstanceSet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EmfSdlPackage.SDL_AGENT_INSTANCE__OWNING_INSTANCE_SET:
				if (resolve) return getOwningInstanceSet();
				return basicGetOwningInstanceSet();
