 ...
 * <ul>
 *   <li>{@link hub.sam.sdl.impl.SdlBehaviorElementImpl#getBehavior <em>Behavior</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class SdlBehaviorElementImpl extends CoreAbstractionsElementsElementImpl implements SdlBehaviorElement {
	...
	public NotificationChain basicSetBehavior(SdlBehavior newBehavior, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EmfSdlPackage.SDL_BEHAVIOR_ELEMENT__BEHAVIOR, oldBehavior, newBehavior);
	...
	public void setBehavior(SdlBehavior newBehavior) {
		if (newBehavior != behavior) {
			...
			if (behavior != null)
				msgs = ((InternalEObject)behavior).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EmfSdlPackage.SDL_BEHAVIOR_ELEMENT__BEHAVIOR, null, msgs);
			if (newBehavior != null)
				msgs = ((InternalEObject)newBehavior).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EmfSdlPackage.SDL_BEHAVIOR_ELEMENT__BEHAVIOR, null, msgs);
			msgs = basicSetBehavior(newBehavior, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfSdlPackage.SDL_BEHAVIOR_ELEMENT__BEHAVIOR, newBehavior, newBehavior));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmfSdlPackage.SDL_BEHAVIOR_ELEMENT__BEHAVIOR:
