...
public class SdlChannelEndImpl extends CoreAbstractionsOwnershipsElementImpl implements SdlChannelEnd {
	 ...
	 * @ordered
	 */
	protected SdlChannelPath channel;
	...
	public SdlChannelPath getChannel() {
		if (channel != null && channel.eIsProxy()) {
			...
			channel = (SdlChannelPath)eResolveProxy(oldChannel);
			if (channel != oldChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmfSdlPackage.SDL_CHANNEL_END__CHANNEL, oldChannel, channel));
			}
		}
		return channel;
	}
	 ...
	 * @generated
	 */
	public SdlChannelPath basicGetChannel() {
		return channel;
	}
	...
	public void setChannel(SdlChannelPath newChannel) {
		SdlChannelPath oldChannel = channel;
		channel = newChannel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfSdlPackage.SDL_CHANNEL_END__CHANNEL, oldChannel, channel));
	}
