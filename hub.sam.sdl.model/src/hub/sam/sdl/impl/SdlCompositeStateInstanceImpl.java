 ...
 * <ul>
 *   <li>{@link hub.sam.sdl.impl.SdlCompositeStateInstanceImpl#getProcess_input <em>Process input</em>}</li>
...
public class SdlCompositeStateInstanceImpl extends SdlInstanceImpl implements SdlCompositeStateInstance {
	 ...
	 * @ordered
	 */
	protected EList<SdlInputInstance> input;
	...
	public EList<CommunicationListener> getProcess_input() {
		if (process_input == null) {
			process_input = new EObjectContainmentEList<CommunicationListener>(CommunicationListener.class, this, EmfSdlPackage.SDL_COMPOSITE_STATE_INSTANCE__PROCESS_INPUT);
		}
	 ...
	 * @generated
	 */
	public EList<SdlInputInstance> getInput() {
		if (input == null) {
			input = new EObjectContainmentWithInverseEList<SdlInputInstance>(SdlInputInstance.class, this, EmfSdlPackage.SDL_COMPOSITE_STATE_INSTANCE__INPUT, EmfSdlPackage.SDL_INPUT_INSTANCE__OWNING_STATE_INSTANCE);
		}
		return input;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EmfSdlPackage.SDL_COMPOSITE_STATE_INSTANCE__INPUT:
				getInput().clear();
				getInput().addAll((Collection<? extends SdlInputInstance>)newValue);
				return;
			case EmfSdlPackage.SDL_COMPOSITE_STATE_INSTANCE__OWNING_INSTANCE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CommunicationProcess.class) {
			switch (derivedFeatureID) {
				case EmfSdlPackage.SDL_COMPOSITE_STATE_INSTANCE__PROCESS_INPUT: return EmfSdlPackage.COMMUNICATION_PROCESS__PROCESS_INPUT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CommunicationProcess.class) {
			switch (baseFeatureID) {
				case EmfSdlPackage.COMMUNICATION_PROCESS__PROCESS_INPUT: return EmfSdlPackage.SDL_COMPOSITE_STATE_INSTANCE__PROCESS_INPUT;
				default: return -1;
			}
		}
