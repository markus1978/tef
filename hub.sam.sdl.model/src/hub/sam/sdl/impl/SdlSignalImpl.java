...
public class SdlSignalImpl extends CommunicationEventTypeImpl implements SdlSignal {
	...
	public EList<CoreAbstractionsBehavioralFeaturesParameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectResolvingEList<CoreAbstractionsBehavioralFeaturesParameter>(CoreAbstractionsBehavioralFeaturesParameter.class, this, EmfSdlPackage.SDL_SIGNAL__PARAMETER);
		}
		return parameter;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CoreAbstractionsBehavioralFeaturesBehavioralFeature.class) {
			switch (derivedFeatureID) {
				case EmfSdlPackage.SDL_SIGNAL__PARAMETER: return EmfSdlPackage.CORE_ABSTRACTIONS_BEHAVIORAL_FEATURES_BEHAVIORAL_FEATURE__PARAMETER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CoreAbstractionsBehavioralFeaturesBehavioralFeature.class) {
			switch (baseFeatureID) {
				case EmfSdlPackage.CORE_ABSTRACTIONS_BEHAVIORAL_FEATURES_BEHAVIORAL_FEATURE__PARAMETER: return EmfSdlPackage.SDL_SIGNAL__PARAMETER;
				default: return -1;
			}
		}
		if (baseClass == SdlNamespace.class) {
