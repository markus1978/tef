 ...
 * <ul>
 *   <li>{@link hub.sam.sdl.impl.SdlStateInstanceImpl#getActualState <em>Actual State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SdlStateInstanceImpl extends EObjectImpl implements SdlStateInstance {
	...
	public EList<SdlStateInstance> getActualState() {
		if (actualState == null) {
			actualState = new EObjectResolvingEList<SdlStateInstance>(SdlStateInstance.class, this, EmfSdlPackage.SDL_STATE_INSTANCE__ACTUAL_STATE);
		}
		return actualState;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfSdlPackage.SDL_STATE_INSTANCE__ACTUAL_STATE:
