...
public class EmfSdlAdapterFactory extends AdapterFactoryImpl {
	...
	protected EmfSdlSwitch<Adapter> modelSwitch =
		new EmfSdlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseConcreteSyntaxSdlStateList(ConcreteSyntaxSdlStateList object) {
				return createConcreteSyntaxSdlStateListAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hub.sam.sdl.ConcreteSyntaxSdlStateList <em>Concrete Syntax Sdl State List</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
