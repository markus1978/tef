...
public class EmfSdlSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EmfSdlPackage.CONCRETE_SYNTAX_SDL_STATE_LIST: {
				ConcreteSyntaxSdlStateList concreteSyntaxSdlStateList = (ConcreteSyntaxSdlStateList)theEObject;
				T result = caseConcreteSyntaxSdlStateList(concreteSyntaxSdlStateList);
				if (result == null) result = caseSdlState(concreteSyntaxSdlStateList);
				if (result == null) result = caseSdlNamedState(concreteSyntaxSdlStateList);
				if (result == null) result = caseCoreAbstractionsStructuralFeaturesStructuralFeature(concreteSyntaxSdlStateList);
				if (result == null) result = caseCoreAbstractionsNamespacesNamedElement(concreteSyntaxSdlStateList);
				if (result == null) result = caseSdlAbstractState(concreteSyntaxSdlStateList);
				if (result == null) result = caseCoreAbstractionsClassifiersFeature(concreteSyntaxSdlStateList);
				if (result == null) result = caseCoreAbstractionsTypedElementsTypedElement(concreteSyntaxSdlStateList);
				if (result == null) result = caseCoreAbstractionsOwnershipsElement(concreteSyntaxSdlStateList);
				if (result == null) result = caseCoreAbstractionsElementsElement(concreteSyntaxSdlStateList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Concrete Syntax Sdl State List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Concrete Syntax Sdl State List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConcreteSyntaxSdlStateList(ConcreteSyntaxSdlStateList object) {
		return null;
	}
