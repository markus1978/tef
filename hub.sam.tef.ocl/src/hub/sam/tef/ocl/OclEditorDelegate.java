...
/**
 * This delegate provides the default behaviour that is common for all the OCL
 * editors. It provides access the the OCL CST meta-model, its packages and
 * ecore file. It also provides the OCL semantics. To realise the OCL semantics
 * this delegates also stores an OCL environment factory and the OCL context.
 */
public class OclEditorDelegate {
